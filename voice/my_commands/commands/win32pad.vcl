...
###
### Version 0.4: word boundaries are Win32Pad's
###
...
<chord> := (
     ...
     | slap=enter   # special case (e.g., pagers)  <<<>>>
...
[<modifiers>] <chord> [1..100] = {$1$2 When($3,_$3)};
...
<kill_word> [1..100] = {$1 When($2,_$2)}{ctrl+x};
...
<leap>       [<count>] <printable> = _Leap($1, $3, When($2,$2,1));
<leap> after [<count>] <printable> = _Leap($1, $3, When($2,$2,1)) {right};
