### 
### Voice commands for Adobe reader
### 
...
[go to] page               1..99  = {shift+ctrl+n} $1 {enter};
[go to] page 1..9 hundred [0..99] = {shift+ctrl+n} Eval($1*100 + When($2,$2,0)) {enter};

fit (page={ctrl+0} | size={ctrl+1} | width={ctrl+2}) = $1;

fit page 1..99 = {ctrl+0} {shift+ctrl+n} $1 {enter};
