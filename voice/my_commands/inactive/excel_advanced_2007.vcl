###
### Advanced voice commands for Microsoft Excel 2007
###
...
start macro = Start("") WaitForWindow("Microsoft Office Excel") y End()
              Start(e)  WaitForWindow("Microsoft Office Excel") y;
