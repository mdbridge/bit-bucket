;;; 
;;; Determine window ID for actual window and return it via ~/AutoHotkey/results.txt
;;; 

;#include C:\Users\Mark\Documents\AutoHotkey\routines.ahk

EnvGet, result, HOME
result := result . "\AutoHotkey\result.txt"


FileDelete,       %result%

ID := ActualID()
; the below appears to be needed to avoid a long Dragon timeout:
WinActivate, ahk_id %ID%

FileAppend, %ID%, %result%
