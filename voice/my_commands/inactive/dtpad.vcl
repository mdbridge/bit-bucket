### 
### Dtpad voice commands, part I
### 
### Version 0.1: line numbers limited to 0..99, word boundaries are dtpad's
### 
...
(file open     |find file)     = {ctrl+o} WaitForWindow("Open")
                                {tab}{alt+down}{home}{tab}{alt+n}; # all files


([file] save as|write file)    = {alt+f} Wait(100) s{down_3} Wait(2000) 
	     	                 # adding the next enter breaks this badly:
	     	      	         {enter} ;#WaitForWindow("Save As");
