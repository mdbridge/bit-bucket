...
;; 
;; Patches/workarounds for Rmail 24.3 bugs:
;; 
;; Warning: rmail-mode-hook is run once per Rmail buffer...
;; 


; disable editing functionality due to numerous unpatched (in 24.3
; only?) editing bugs:
; e.g., #9841, #13327, #13328

(defun mdl-edit-message ()
  (interactive)
  (error "Rmail 24.3 edit message command is badly broken"))
...
; my patch for bug #9521:

(require 'rmailmm)  ; prevent loading this later from overwriting the patch...
...
; bug #10078 supposedly fixed in 24.3: Rmail's rmail-mine command (v)
; does not correctly display raw message when rmail-enable mime is
; true
